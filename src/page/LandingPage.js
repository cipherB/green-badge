...
import InViewAnimateTop from '../component/InViewAnimateTop';
import InViewAnimateGrow from '../component/InViewAnimateGrow';
import InViewAnimateLeft from '../component/InViewAnimateLeft';
import InViewAnimateRight from '../component/InViewAnimateRight';

const LandingPage = () => {
  // const { scrollYProgress } = useViewportScroll();
  // const scale = useTransform(scrollYProgress, [0,1], [1, 20]);
  // console.log("scroll show", scrollYProgress)
  return (
    <div>
